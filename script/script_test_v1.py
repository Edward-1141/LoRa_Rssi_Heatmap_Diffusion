...
from app.dataset import load_data_and_split, load_data_v1
from app.context_unet import ContextUnetV1
...
def recall_and_regenerate_edward_test(
    ...
    selected_samples = []
    selected_idx = [(1, 0), (1, 1), (1, 2), (1, 3), (1, 4), (1, 5)]
...
if __name__ == "__main__":
    ...
    recall_and_regenerate_edward_test(checkpoint_path, test_dataset, device="cuda", save_dir="output/recall_images", conditions_size_list=np.arange(100, 601, 100))